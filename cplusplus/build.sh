...
g++ -I"$GLFW3_HOME/include" -L"$GLFW3_HOME/lib" -framework iokit -framework cocoa -framework opengl -framework CoreVideo word_texture.cpp tga_reader.cpp -lglfw3 -o word_texture
